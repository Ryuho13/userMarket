...
INSERT INTO products (seller_id, category_id, title, status, sell_price, description) VALUES
-- 1️⃣ 홍길동 (전자)
(1, 1, '맥북 프로 16 M1 Pro', 'SALE', 2500000, 'M1 Pro 칩, 풀박스'),
(1, 1, '아이폰 15 Pro 256GB', 'SALE', 1600000, '티타늄 블루, 미개봉'),
(1, 1, '에어팟 맥스 실버', 'SALE', 690000, '상태 A급'),
(1, 1, '갤럭시 탭 S9 울트라', 'SALE', 1200000, '12.9인치 OLED'),
(1, 1, 'LG 그램 17', 'SALE', 1350000, 'i7, 16GB RAM, 512GB SSD'),
(1, 1, '로지텍 MX 마스터3', 'SALE', 110000, '무선 마우스 신형'),
(1, 1, '소니 노이즈캔슬링 헤드폰 WH-1000XM5', 'SALE', 410000, '박스 있음'),
(1, 1, '삼성 커브드 모니터 32인치', 'SALE', 270000, '거의 새것'),
(1, 1, 'LG 사운드바', 'SALE', 320000, 'TV 연동 가능'),
(1, 1, '샤오미 전동 킥보드', 'SALE', 550000, '주행거리 짧음'),

-- 2️⃣ 김철수 (가구)
(2, 2, '원목 4인용 테이블', 'SALE', 150000, '생활기스 있음'),
(2, 2, '북유럽풍 의자 세트', 'SALE', 90000, '화이트 컬러'),
(2, 2, '2단 수납장', 'SALE', 80000, '튼튼한 원목'),
(2, 2, '거실장', 'SALE', 200000, 'TV장용, 원목 재질'),
(2, 2, '책상 + 의자 세트', 'SALE', 130000, '공부용'),
(2, 2, '벽걸이 선반', 'SALE', 30000, '장식용으로 좋음'),
(2, 2, '서랍장 5단', 'SALE', 160000, '화이트톤'),
(2, 2, '빈티지 협탁', 'SALE', 60000, '포인트 가구'),
(2, 2, '식탁보 세트', 'SALE', 20000, '원단 새것'),
(2, 2, '수납형 벤치', 'SALE', 120000, '내부 수납 가능'),

-- 3️⃣ 이영희 (도서)
(3, 4, '소설책 세트 (베스트셀러 10권)', 'SALE', 30000, '깨끗한 상태'),
(3, 4, '자기계발서 15권 세트', 'SALE', 50000, '베스트셀러 위주'),
(3, 4, '영어 회화 교재 세트', 'SALE', 25000, '초중급자용'),
(3, 4, '어린이 동화책 20권', 'SALE', 40000, '유아용'),
(3, 4, '경제서적 12권', 'SALE', 42000, '투자/창업용'),
(3, 4, '과학 잡지 1년치', 'SALE', 30000, '최신호 포함'),
(3, 4, '일본어 교재 세트', 'SALE', 28000, '기초회화'),
(3, 4, '한국사 문제집 모음', 'SALE', 32000, '수험생용'),
(3, 4, '미스터리소설 전집', 'SALE', 37000, '추리소설 애호가'),
(3, 4, '철학 서적 모음', 'SALE', 31000, '입문자용'),

-- 4️⃣ 박민수 (운동기구)
(4, 6, '가정용 러닝머신', 'RESERVED', 450000, '소음 적음'),
(4, 6, '아령세트', 'SALE', 65000, '3kg~10kg 구성'),
(4, 6, '요가매트', 'SALE', 20000, '깔끔함'),
(4, 6, '벤치프레스 세트', 'SALE', 220000, '운동용'),
(4, 6, '폼롤러', 'SALE', 15000, '스트레칭용'),
(4, 6, '푸쉬업바', 'SALE', 12000, '가정용 운동기기'),
(4, 6, '헬스장용 철봉', 'SALE', 45000, '벽걸이형'),
(4, 6, '스텝퍼', 'SALE', 35000, '공간 절약형'),
(4, 6, '실내자전거', 'SALE', 120000, '조용한 모델'),
(4, 6, '운동 밴드 세트', 'SALE', 18000, '홈트레이닝 필수'),

-- 5️⃣ 최유진 (패션)
(5, 3, '롱코트 (여성용)', 'SALE', 80000, '따뜻하고 가벼움'),
(5, 3, '트렌치코트', 'SALE', 65000, '봄 가을용'),
(5, 3, '가죽 자켓', 'SALE', 120000, '블랙, 새것'),
(5, 3, '니트 가디건', 'SALE', 40000, '부드러운 재질'),
(5, 3, '블라우스 세트', 'SALE', 30000, '오피스룩'),
(5, 3, '데님 재킷', 'SALE', 55000, '빈티지 디자인'),
(5, 3, '롱스커트', 'SALE', 45000, '새상품'),
(5, 3, '여성 정장 세트', 'SALE', 150000, '한 번 착용'),
(5, 3, '패딩 점퍼', 'SALE', 90000, '겨울 신상'),
(5, 3, '스카프 3종 세트', 'SALE', 25000, '새상품'),

-- 6️⃣ 정은지 (생활용품)
(6, 5, '청소기 새상품', 'SOLD_OUT', 50000, '미개봉'),
(6, 5, '로봇청소기 R9', 'RESERVED', 280000, '자동 충전 가능'),
(6, 5, '에어프라이어 5L', 'SALE', 90000, '새상품'),
(6, 5, '커피머신 세트', 'SALE', 130000, '캡슐 포함'),
(6, 5, '전기밥솥 10인용', 'SALE', 80000, '정상 작동'),
(6, 5, '가습기', 'SALE', 60000, '겨울 필수템'),
(6, 5, '공기청정기', 'SALE', 150000, '미세먼지 제거'),
(6, 5, '전기포트', 'SALE', 30000, '깨끗한 상태'),
(6, 5, '드라이기', 'SALE', 45000, '고속 건조형'),
(6, 5, '다리미', 'SALE', 25000, '가벼운 스팀형');
