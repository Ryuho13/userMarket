...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/user/css/login.css">
</head>
<body>
	...
	<div class="login-card-container">
		<div class="login-card">
			...
			<div class="alert alert-danger d-none" id="login-error">아이디와
				비밀번호를 확인해주세요.</div>
			...
			<form class="form-signin"
				...
				<div class="form-floating mb-3">
					<input type="text" class="form-control" name="id"
						...
						for="floatingInput">아이디 (ID)</label>
				</div>
				<div class="form-floating mb-3">
					<input type="password" class="form-control" name="pw"
						id="floatingPassword" placeholder="Password" required> <label
						for="floatingPassword">비밀번호 (Password)</label>
				</div>
